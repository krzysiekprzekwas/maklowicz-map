      ...
      <div className="flex items-center justify-end md:justify-center gap-2 mt-4 px-4 md:px-24 relative">
        ...
        <div className="flex gap-2 justify-end md:absolute md:right-24">
          <button
            ...
            className="w-10 h-10 rounded-full flex items-center justify-center transition-colors disabled:bg-neutral-200 disabled:text-neutral-300 bg-neutral-1000 text-neutral-0 md:hover:bg-accent-blue"
