  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ zIndex: 1000 }}
      >
        <span className="inline-flex items-center gap-2.5 px-8 py-4 rounded-full bg-neutral-1000 text-neutral-0 font-semibold text-base hover:bg-accent-blue transition-colors">
